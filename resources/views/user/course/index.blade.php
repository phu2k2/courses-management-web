                        ...
                        <div class="mb-4 mb-xl-0 ms-xl-6">
                            ...
                            <form class="">
                                <div class="input-group input-group-filter float-xl-end">
                                    <input class="form-control form-control-sm placeholder-dark border-end-0 shadow-none" type="search" placeholder="Search your courses" aria-label="Search">
            ...
            <div class="col-md mb-6 pb-4 pb-md-7">
                ...
                <div class="card border shadow p-2 lift sk-fade">
                    ...
                    <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        ...
                        <!-- Preheading -->
                        <a href="#"><span
                                class="mb-1 d-inline-block text-gray-800">Programming Language</span></a>

                        <!-- Heading -->
                        <div class="position-relative">
                            <a href="#" class="d-block stretched-link">
                                <h4 class="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">PHP Basic</h4>
                            </a>
                            ...
                            <div class="row mx-n2 align-items-end">
                                    ...
                                    <ul class="nav mx-n3">
                                        ...
                                        <li class="nav-item px-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="font-size-sm">20h</div>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="col-auto px-2 text-right">
                                    <del class="font-size-sm">$5.99</del>
                                    <ins class="h4 mb-0 d-block mb-lg-n1">$4</ins>
                                </div>
                            </div>
                        </div>
                    </div>
