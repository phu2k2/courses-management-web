                    ...
                    <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        ...
                        <ul class="nav mx-n3 mb-3 d-xl-flex align-items-center">
                            <li class="nav-item px-3 badge badge-lg badge-purple badge-pill ms-2 px-5">
                                <a href="#"><span class="mb-1 d-inline-block text-white font-size-sm">Programming Language</span></a>
                            </li>
                        </ul>
            ...
            <div class="col-md mb-6 pb-4 pb-md-7">
                ...
                <div class="card border shadow p-2 lift sk-fade">
                    ...
                    <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        ...
                        <div class="position-relative">
                            <a href="#" class="d-block stretched-link">
                                <h4 class="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">PHP Full Course | PHP Tutorial For Beginners</h4>
                            </a>
