                                    ...
                                    <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                        ...
                                        <tbody>
                                            ...
                                            <td style="width:550px;" class="mj-full-width-mobile">
                                                <img alt="image description" height="auto" src="https://img.freepik.com/premium-vector/welcome-sign-people-great-design-any-purposes-vector-illustration-business-concept_123447-3872.jpg" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:60%;font-size:13px; padding-left:20%"/>
                                            </td>
                                            </tr>
                                        </tbody>
                                        </table>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <div style="font-family:Montserrat, Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:20px;text-align:left;color:#8189A9;">
                                                                ...
                                                                <p>To start with SupremeMethod, please confirm you email address.</p>
                                                                <p>This email will expire in 1 day.</p><br>

                                                                <p>Best regards,</p>
                                                                <p><b>SUPREMEMETHOD</b></p>
                                                            </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
