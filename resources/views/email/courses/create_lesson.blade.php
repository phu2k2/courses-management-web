                            ...
                            <tbody><tr>
                              <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Montserrat, Helvetica, Arial, sans-serif;font-size:20px;font-weight:400;line-height:30px;text-align:center;color:#8189A9;">
                                  <h2 style="margin: 0; font-weight: bold; font-size: 20px; line-height: 24px;">New Course Update Notification</h2>
                                </div>
                              </td>
                            </tr>
                          </tbody></table>
                        ...
                        <tbody>
                          <tr>
                            <td style="width:550px;" class="mj-full-width-mobile">
                              <img alt="image description" height="auto" src="https://digitalica-ltd.com/img/content/seo-optimization-01.svg?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=800&amp;q=80" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="550" />
                            </td>
                          </tr>
                        </tbody>
                      </table>
