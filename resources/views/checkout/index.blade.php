                    ...
                    <div class="entry-content">
                        <div class="woocommerce">
                            <div class="woocommerce-order">
                                ...
                                <button class="btn btn-primary btn-wide lift d-none d-lg-inline-block aos-init aos-animate"
                                    data-aos-duration="200" data-aos="fade-up" style="width:100%">Pay the order</button>
                            </div>
                        </div>
                    </div>
                </div>
