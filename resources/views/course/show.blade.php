            ...
            <div class="col-lg-8 mb-6 mb-lg-0 position-relative">
                ...
                <div class="d-md-flex align-items-center mb-5 course-single-white">
                    <div class="border rounded-circle d-inline-block mb-4 mb-md-0 me-md-6 me-lg-4 me-xl-6 bg-white">
                        <div class="p-2">
                            <img src="{{ asset('assets/img/avatars/avatar-1.jpg') }}" alt="..." class="rounded-circle" width="68"
                                height="68">
                        </div>
                    </div>
                                ...
                                <div class="border rounded shadow mb-6 overflow-hidden">
                                    ...
                                    <div id="Curriculumcollapse{{ $key }}" class="collapse {{ $key == 0 ? 'show' : '' }}"
                                        ...
                                        @foreach ($topic->lessons as $key=>$lesson)
                                            <div class="border-top px-5 py-4 min-height-70 d-md-flex align-items-center {{ ($key % 2 == 1) ? 'bg-gray-100' : '' }}">
